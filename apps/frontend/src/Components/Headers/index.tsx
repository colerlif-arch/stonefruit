...
const Header = () => {
  ...
  return (
    <div className={styles.grid}>
      <h3 className={styles.title}>Stonefruit</h3>

      {!linkSuccess ? (
        <>
          <h4 className={styles.subtitle}>
            Plaid ingestion console for Stonefruit
          </h4>
          <p className={styles.introPar}>
            Use this temporary UI to connect an account with Plaid Link and
            ingest raw transaction data into Stonefruit. This layer is strictly
            for source ingestion and persistence.
          </p>
          ...
          linkToken == null && backend ? (
            <Callout warning>
              ...
              <div>
                ...
                <InlineLink
                  href="https://docs.github.com/en/repositories/creating-and-managing-repositories/troubleshooting-cloning-errors#unable-to-checkout-working-tree"
                  target="_blank"
                >
                  symlinks turned on.
                </InlineLink>{" "}
            ...
            /* If not using the payment_initiation product, show the item_id and access_token information */ <>
              {isItemAccess ? (
                <h4 className={styles.subtitle}>
                  ...
                  <InlineLink
                    href="https://plaid.com/docs/api/items/"
                    target="_blank"
                  >
                    Item
                  </InlineLink>
              ...
              {(isItemAccess || userToken || userId) && (
                <p className={styles.requests}>
                  ...
                  {userId && "a user_id"}, you can run ingestion and retrieval
                  requests:
                </p>
              )}
            </>
